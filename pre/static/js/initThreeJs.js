...
function update() {
    ...
    cameraArray.forEach(geo=>{
        geo.lookAt(camera.position)
    });
    ...
    // cameraGroup.position.x = -300*Math.sin(phase);
    // cameraGroup.position.z = 400*Math.sin(phase);
}
...
function addCamera({id,cameraPosition,ballPosition,isNormal}) {
    ...
    let texture = THREE.ImageUtils.loadTexture('static/img/geo.png',{},function () {
        ...
        let geo = new THREE.PlaneGeometry(30,30,30,30);
        // let pen = new THREE.Shape();
        // pen.moveTo(0,0);
        // pen.lineTo(-10,20);
        // pen.quadraticCurveTo(0,30,10,20);
        // pen.lineTo(0,0);
        // let geo = new THREE.ShapeGeometry(pen);
        plane = new THREE.Mesh(geo,mat);

        plane.position.copy(cameraPosition);
        plane.lookAt(camera.position)
        // plane.scale.set(.7,.7,.7);
        plane.name = "camera"+id;
        cameraArray.push(plane);
        scene.add(plane);
        addMouseTipaAndClick(plane,function () {
